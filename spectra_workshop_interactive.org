...
- Evaluate R code from the /spectra_workshop_interactive.Rmd/ file - or watch me
  doing that.
...
- _Example_: change backend to =MsBackendDataFrame=.
  #+begin_src R
    ...
    ## access to m/z and intensity values is faster
    mz(sps)
    intensity(sps)
...
- Human Metabolome Database: MS2 spectra available as individual xml files.
...
*** Integrate new packages into your own workflow/software
